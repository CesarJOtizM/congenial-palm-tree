...
export const baseConfig = [
  ...
  ...tseslint.configs.recommended,
  {
    ...
    rules: {
      ...
      // Convención para nombres de archivos: CAMEL_CASE para JS, PASCAL_CASE para componentes React
      'check-file/filename-naming-convention': [
        'error',
        {
          // Archivos de configuración: CAMEL_CASE (solo archivos .js)
          '**/!(vitest.config|vite.config|next.config|astro.config|tailwind.config|postcss.config|eslint.config|.stylelintrc).js':
            'CAMEL_CASE',
          // Componentes React/Astro: PASCAL_CASE (excluyendo páginas y archivos index)
          '**/!(pages|app)/**/!(index).{jsx,tsx}': 'PASCAL_CASE',
          '**/!(pages|app)/**/!(index).astro': 'PASCAL_CASE',
        },
      ],
  ...
  // Ignorar archivos generados automáticamente
  {
    ignores: [
      ...
      '**/eslint.config.{js,ts}',
      '**/.stylelintrc.{js,ts}',
      // Ignorar la carpetas de rutas de Next.js y Astro
      '**/src/app/**',
      '**/src/pages/**',
      '**/repl/**',
    ],
